                ...
                <div class="header_container">
                    <div class="header-wrap">
                        ...
                        <ul class="header-menu">
                            <li><a href=""><img src="./img/user.png" alt="user"></a></li>
            ...
            <section class="userCabinet">
                <div class="container">
                    <div class="cabinet-header">
                        <span style="font-size: 26px; font-weight: 500;">Вход в кабинет покупателя</span>
                    </div>
                    <div class="cabinet-wrapper">
                        <div class="cabinet-content">
                            <div class="login-panel">
                                <form action="" name="login_form" class="form-grid">
                                    ...
                                    <div class="submit-btns">
                                        <button class="catalogBtns">Войти</button>
                                        <a href="./userCopy.php">Зарегистрироваться</a>
                                    </div>
                                </form>
                            </div>
                        </div>
